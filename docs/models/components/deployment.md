...
let value: Deployment = {
  ...
  createdAt: new Date("2025-10-27T17:07:18.797Z"),
  ...
  build: {
    ...
    imageSize: 748664,
    status: "failed",
    deletedAt: new Date("2023-04-02T10:20:37.470Z"),
    finishedAt: new Date("2024-08-28T04:52:14.624Z"),
    startedAt: new Date("2024-10-02T14:03:30.664Z"),
