...
export class LobbiesV2 extends ClientSDK {
    ...
    async createPrivateLobby(
        ...
        return unwrapAsync(
            lobbiesV2CreatePrivateLobby(this, security, requestBody, appId, roomId, options)
        );
    }
    ...
    async createPublicLobby(
        ...
        return unwrapAsync(
            lobbiesV2CreatePublicLobby(this, security, requestBody, appId, roomId, options)
        );
    }
    ...
    async createLocalLobby(
        ...
        return unwrapAsync(
            lobbiesV2CreateLocalLobby(this, security, requestBody, appId, roomId, options)
        );
    }
    ...
    async listActivePublicLobbiesDeprecatedV2(
        ...
        return unwrapAsync(
            lobbiesV2ListActivePublicLobbiesDeprecatedV2(this, appId, region, options)
        );
    }
    ...
    async getLobbyInfo(
        ...
        return unwrapAsync(lobbiesV2GetLobbyInfo(this, roomId, appId, options));
    }
    ...
    async setLobbyState(
        ...
        return unwrapAsync(
            lobbiesV2SetLobbyState(this, roomId, setLobbyStateParams, appId, options)
        );
    }
}
