...
export class ProcessesV3 extends ClientSDK {
    ...
    async getLatestProcesses(
        ...
        return unwrapAsync(processesV3GetLatestProcesses(this, appId, status, region, options));
    }
    ...
    async getProcessesCountExperimental(
        ...
        return unwrapAsync(
            processesV3GetProcessesCountExperimental(this, appId, status, region, options)
        );
    }
    ...
    async createProcess(
        ...
        return unwrapAsync(processesV3CreateProcess(this, region, appId, options));
    }
    ...
    async getProcess(
        ...
        return unwrapAsync(processesV3GetProcess(this, processId, appId, options));
    }
    ...
    async stopProcess(
        ...
        return unwrapAsync(processesV3StopProcess(this, processId, appId, options));
    }
}
