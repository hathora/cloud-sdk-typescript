...
export class DeploymentsV2 extends ClientSDK {
    ...
    async getDeploymentsV2Deprecated(
        ...
        return unwrapAsync(deploymentsV2GetDeploymentsV2Deprecated(this, appId, options));
    }
    ...
    async getLatestDeploymentV2Deprecated(
        ...
        return unwrapAsync(deploymentsV2GetLatestDeploymentV2Deprecated(this, appId, options));
    }
    ...
    async getDeploymentInfoV2Deprecated(
        ...
        return unwrapAsync(
            deploymentsV2GetDeploymentInfoV2Deprecated(this, deploymentId, appId, options)
        );
    }
