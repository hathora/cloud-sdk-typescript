...
export class LobbyV3SDK {
    ...
    async createLobby(
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new models.CreateLobbySecurity(security);
        }
        ...
        const res: models.CreateLobbyResponse = new models.CreateLobbyResponse({
        ...
        switch (true) {
            case httpRes?.status == 201:
                if (utils.matchContentType(responseContentType, `application/json`)) {
                    res.lobbyV3 = utils.objectToClass(JSON.parse(decodedRes), models.LobbyV3);
                } else {
    ...
    async getLobbyInfoByRoomId(
        ...
        const req = new models.GetLobbyInfoByRoomIdRequest({
            roomId: roomId,
            appId: appId,
        });
        const baseURL: string = utils.templateUrl(
        ...
        const res: models.GetLobbyInfoByRoomIdResponse = new models.GetLobbyInfoByRoomIdResponse({
            statusCode: httpRes.status,
            contentType: responseContentType,
            rawResponse: httpRes,
        });
    ...
    async getLobbyInfoByShortCode(
        ...
        const req = new models.GetLobbyInfoByShortCodeRequest({
            shortCode: shortCode,
            appId: appId,
        });
        const baseURL: string = utils.templateUrl(
        ...
        const res: models.GetLobbyInfoByShortCodeResponse =
            new models.GetLobbyInfoByShortCodeResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
    ...
    async listActivePublicLobbies(
        ...
        const req = new models.ListActivePublicLobbiesRequest({
            appId: appId,
            region: region,
        });
        const baseURL: string = utils.templateUrl(
        ...
        const res: models.ListActivePublicLobbiesResponse =
            new models.ListActivePublicLobbiesResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
