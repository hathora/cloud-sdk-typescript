...
/** @internal */
export const ListActivePublicLobbiesDeprecatedV1Globals$inboundSchema: z.ZodType<
...
/** @internal */
export const ListActivePublicLobbiesDeprecatedV1Globals$outboundSchema: z.ZodType<
...
export namespace ListActivePublicLobbiesDeprecatedV1Globals$ {
    ...
    export const inboundSchema = ListActivePublicLobbiesDeprecatedV1Globals$inboundSchema;
    /** @deprecated use `ListActivePublicLobbiesDeprecatedV1Globals$outboundSchema` instead. */
    export const outboundSchema = ListActivePublicLobbiesDeprecatedV1Globals$outboundSchema;
...
/** @internal */
export const ListActivePublicLobbiesDeprecatedV1Request$inboundSchema: z.ZodType<
...
/** @internal */
export const ListActivePublicLobbiesDeprecatedV1Request$outboundSchema: z.ZodType<
...
export namespace ListActivePublicLobbiesDeprecatedV1Request$ {
    ...
    export const inboundSchema = ListActivePublicLobbiesDeprecatedV1Request$inboundSchema;
    /** @deprecated use `ListActivePublicLobbiesDeprecatedV1Request$outboundSchema` instead. */
    export const outboundSchema = ListActivePublicLobbiesDeprecatedV1Request$outboundSchema;
