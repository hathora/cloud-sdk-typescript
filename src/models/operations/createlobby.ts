...
export namespace CreateLobbyGlobals$ {
    export const inboundSchema: z.ZodType<CreateLobbyGlobals, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateLobbyGlobals> = z.object({
        appId: z.string().optional(),
    });
}
...
export namespace CreateLobbySecurity$ {
    export const inboundSchema: z.ZodType<CreateLobbySecurity, z.ZodTypeDef, unknown> = z.object({
        playerAuth: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateLobbySecurity> = z.object({
        playerAuth: z.string(),
    });
}
