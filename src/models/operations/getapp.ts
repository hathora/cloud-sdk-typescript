...
/** @internal */
export const GetAppGlobals$inboundSchema: z.ZodType<GetAppGlobals, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetAppRequest$inboundSchema: z.ZodType<GetAppRequest, z.ZodTypeDef, unknown> =
    z.object({
        appId: z.string().optional(),
    });
