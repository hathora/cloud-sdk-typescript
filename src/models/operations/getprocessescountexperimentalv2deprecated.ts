...
/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedGlobals$inboundSchema: z.ZodType<
...
/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedGlobals$outboundSchema: z.ZodType<
...
export namespace GetProcessesCountExperimentalV2DeprecatedGlobals$ {
    ...
    export const inboundSchema = GetProcessesCountExperimentalV2DeprecatedGlobals$inboundSchema;
    /** @deprecated use `GetProcessesCountExperimentalV2DeprecatedGlobals$outboundSchema` instead. */
    export const outboundSchema = GetProcessesCountExperimentalV2DeprecatedGlobals$outboundSchema;
    /** @deprecated use `GetProcessesCountExperimentalV2DeprecatedGlobals$Outbound` instead. */
    export type Outbound = GetProcessesCountExperimentalV2DeprecatedGlobals$Outbound;
}

/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedRequest$outboundSchema: z.ZodType<
...
export namespace GetProcessesCountExperimentalV2DeprecatedRequest$ {
    ...
    export const inboundSchema = GetProcessesCountExperimentalV2DeprecatedRequest$inboundSchema;
    /** @deprecated use `GetProcessesCountExperimentalV2DeprecatedRequest$outboundSchema` instead. */
    export const outboundSchema = GetProcessesCountExperimentalV2DeprecatedRequest$outboundSchema;
    /** @deprecated use `GetProcessesCountExperimentalV2DeprecatedRequest$Outbound` instead. */
    export type Outbound = GetProcessesCountExperimentalV2DeprecatedRequest$Outbound;
}

/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const GetProcessesCountExperimentalV2DeprecatedResponseBody$outboundSchema: z.ZodType<
...
export namespace GetProcessesCountExperimentalV2DeprecatedResponseBody$ {
    ...
    export type Outbound = GetProcessesCountExperimentalV2DeprecatedResponseBody$Outbound;
}
