...
/** @internal */
export const ProcessV3$inboundSchema: z.ZodType<ProcessV3, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const ProcessV3$outboundSchema: z.ZodType<ProcessV3$Outbound, z.ZodTypeDef, ProcessV3> =
    z.object({
