...
/** @internal */
export const BuildWithMultipartUrlsRegionalContainerTags$inboundSchema: z.ZodType<
...
/** @internal */
export const BuildWithMultipartUrlsRegionalContainerTags$outboundSchema: z.ZodType<
...
export namespace BuildWithMultipartUrlsRegionalContainerTags$ {
    ...
    export const inboundSchema = BuildWithMultipartUrlsRegionalContainerTags$inboundSchema;
    /** @deprecated use `BuildWithMultipartUrlsRegionalContainerTags$outboundSchema` instead. */
    export const outboundSchema = BuildWithMultipartUrlsRegionalContainerTags$outboundSchema;
...
export type BuildWithMultipartUrls$Outbound = {
    buildTag?: string | null | undefined;
    regionalContainerTags: Array<BuildWithMultipartUrlsRegionalContainerTags$Outbound>;
    imageSize: number;
    status: string;
