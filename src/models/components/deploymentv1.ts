 ...
 * @deprecated enum: This will be removed in a future release, please migrate away from it as soon as possible.
 */
export type DeploymentV1TransportType = OpenEnum<typeof DeploymentV1TransportType>;
...
export const DeploymentV1TransportType$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([z.nativeEnum(DeploymentV1TransportType), z.string().transform(catchUnrecognizedEnum)]);
...
/** @internal */
export const DeploymentV1$inboundSchema: z.ZodType<DeploymentV1, z.ZodTypeDef, unknown> = z.object({
