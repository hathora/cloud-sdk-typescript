...
/** @internal */
export const AppConfig$inboundSchema: z.ZodType<AppConfig, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const AppConfig$outboundSchema: z.ZodType<AppConfig$Outbound, z.ZodTypeDef, AppConfig> =
    z.object({
