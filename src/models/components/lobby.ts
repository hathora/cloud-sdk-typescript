...
export namespace CreatedBy$ {
    export const inboundSchema: z.ZodType<CreatedBy, z.ZodTypeDef, unknown> = z.union([
        z.string(),
        z.number(),
    ]);

    export type Outbound = string | number;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreatedBy> = z.union([
        z.string(),
        z.number(),
    ]);
}
