...
/** @internal */
export const LobbyV3CreatedBy$inboundSchema: z.ZodType<LobbyV3CreatedBy, z.ZodTypeDef, unknown> =
...
/** @internal */
export const LobbyV3$inboundSchema: z.ZodType<LobbyV3, z.ZodTypeDef, unknown> = z.object({
    shortCode: z.string(),
    createdAt: z
        .string()
...
/** @internal */
export const LobbyV3$outboundSchema: z.ZodType<LobbyV3$Outbound, z.ZodTypeDef, LobbyV3> = z.object({
    shortCode: z.string(),
