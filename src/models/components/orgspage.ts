...
/** @internal */
export const OrgsPage$inboundSchema: z.ZodType<OrgsPage, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const OrgsPage$outboundSchema: z.ZodType<OrgsPage$Outbound, z.ZodTypeDef, OrgsPage> =
    z.object({
