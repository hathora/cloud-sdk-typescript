...
/** @internal */
export const DeploymentV3Env$inboundSchema: z.ZodType<DeploymentV3Env, z.ZodTypeDef, unknown> =
    z.object({
        value: z.string(),
        name: z.string(),
    });
...
/** @internal */
export const DeploymentV3$inboundSchema: z.ZodType<DeploymentV3, z.ZodTypeDef, unknown> = z.object({
