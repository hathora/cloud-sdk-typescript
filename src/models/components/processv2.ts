...
/** @internal */
export const ProcessV2$inboundSchema: z.ZodType<ProcessV2, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const ProcessV2$outboundSchema: z.ZodType<ProcessV2$Outbound, z.ZodTypeDef, ProcessV2> =
    z.object({
