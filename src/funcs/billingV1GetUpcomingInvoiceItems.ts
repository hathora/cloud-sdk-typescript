 ...
 */
export function billingV1GetUpcomingInvoiceItems(
...
> {
  const input: operations.GetUpcomingInvoiceItemsRequest = {
    orgId: orgId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetUpcomingInvoiceItemsRequest$outboundSchema.parse(value),
