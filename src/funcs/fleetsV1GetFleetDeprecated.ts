 ...
 */
export function fleetsV1GetFleetDeprecated(
...
> {
  const input: operations.GetFleetDeprecatedRequest = {
    fleetId: fleetId,
    orgId: orgId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetFleetDeprecatedRequest$outboundSchema.parse(value),
