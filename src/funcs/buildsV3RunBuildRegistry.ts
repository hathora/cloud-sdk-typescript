 ...
 */
export function buildsV3RunBuildRegistry(
...
> {
  const input: operations.RunBuildRegistryRequest = {
    buildId: buildId,
  ...
  const parsed = safeParse(
    input,
    (value) => operations.RunBuildRegistryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RegistryConfig, { explode: true });
  ...
  const path = pathToFunc("/builds/v3/builds/{buildId}/runRegistry")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "404", "408", "422", "429", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr([400, 401, 404, 408, 422, 429], errors.ApiError$inboundSchema),
