 ...
 */
export function roomsV2GetActiveRoomsForProcess(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetActiveRoomsForProcessRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rooms/v2/{appId}/list/{processId}/active")(
    pathParams,
  );
