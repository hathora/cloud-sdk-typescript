 ...
 */
export async function processesV1GetStoppedProcesses(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetStoppedProcessesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/processes/v1/{appId}/list/stopped")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.Process$inboundSchema)),
