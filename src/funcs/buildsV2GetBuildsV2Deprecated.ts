 ...
 */
export async function buildsV2GetBuildsV2Deprecated(
    ...
    >
> {
    const input$: operations.GetBuildsV2DeprecatedRequest = {
        appId: appId,
    };

    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetBuildsV2DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/builds/v2/{appId}/list")(pathParams$);
