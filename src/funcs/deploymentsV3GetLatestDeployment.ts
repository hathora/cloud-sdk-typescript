 ...
 */
export async function deploymentsV3GetLatestDeployment(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetLatestDeploymentRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/deployments/v3/apps/{appId}/deployments/latest")(
    pathParams$,
  );
