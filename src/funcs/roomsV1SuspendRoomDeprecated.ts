 ...
 */
export async function roomsV1SuspendRoomDeprecated(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SuspendRoomDeprecatedRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rooms/v1/{appId}/suspend/{roomId}")(pathParams);
