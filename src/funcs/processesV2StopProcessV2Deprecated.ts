 ...
 */
export async function processesV2StopProcessV2Deprecated(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.StopProcessV2DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/processes/v2/{appId}/stop/{processId}")(pathParams$);
