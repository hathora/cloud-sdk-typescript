 ...
 */
export async function buildsV1GetBuildInfoDeprecated(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetBuildInfoDeprecatedRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/builds/v1/{appId}/info/{buildId}")(pathParams);
