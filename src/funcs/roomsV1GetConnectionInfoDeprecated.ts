 ...
 */
export function roomsV1GetConnectionInfoDeprecated(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetConnectionInfoDeprecatedRequest$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "402", "404", "408", "429", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr([400, 402, 404, 408, 429], errors.ApiError$inboundSchema),
