 ...
 */
export async function lobbiesV2CreatePublicLobby(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.CreatePublicLobbyRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/lobby/v2/{appId}/create/public")(pathParams$);
