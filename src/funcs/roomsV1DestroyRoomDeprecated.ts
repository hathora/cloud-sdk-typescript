 ...
 */
export async function roomsV1DestroyRoomDeprecated(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.DestroyRoomDeprecatedRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/rooms/v1/{appId}/destroy/{roomId}")(pathParams$);
