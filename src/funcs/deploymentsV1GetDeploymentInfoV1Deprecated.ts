 ...
 */
export async function deploymentsV1GetDeploymentInfoV1Deprecated(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetDeploymentInfoV1DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/deployments/v1/{appId}/info/{deploymentId}")(pathParams$);
