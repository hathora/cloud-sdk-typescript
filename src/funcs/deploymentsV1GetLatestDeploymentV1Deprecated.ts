 ...
 */
export async function deploymentsV1GetLatestDeploymentV1Deprecated(
    ...
    >
> {
    const input$: operations.GetLatestDeploymentV1DeprecatedRequest = {
        appId: appId,
    };

    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetLatestDeploymentV1DeprecatedRequest$outboundSchema.parse(value$),
