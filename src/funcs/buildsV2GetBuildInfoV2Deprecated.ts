 ...
 */
export async function buildsV2GetBuildInfoV2Deprecated(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetBuildInfoV2DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/builds/v2/{appId}/info/{buildId}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.Build$inboundSchema),
