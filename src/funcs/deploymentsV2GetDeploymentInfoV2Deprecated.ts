...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetDeploymentInfoV2DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/deployments/v2/{appId}/info/{deploymentId}")(pathParams$);
