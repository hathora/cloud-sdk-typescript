 ...
 */
export async function deploymentsV1GetLatestDeploymentDeprecated(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetLatestDeploymentDeprecatedRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.Deployment$inboundSchema),
