 ...
 */
export function fleetsV1UpdateFleetRegionDeprecated(
...
> {
  const input: operations.UpdateFleetRegionDeprecatedRequest = {
    fleetId: fleetId,
    region: region,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdateFleetRegionDeprecatedRequest$outboundSchema.parse(value),
