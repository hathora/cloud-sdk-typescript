 ...
 * ResumeRoom
 */
export async function roomsV2ResumeRoom(
  ...
  >
> {
  const input: operations.ResumeRoomRequest = {
    roomId: roomId,
    appId: appId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => operations.ResumeRoomRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rooms/v2/{appId}/resume/{roomId}")(pathParams);
