 ...
 */
export function appsV1GetAppInfoV1Deprecated(
...
> {
  const input: operations.GetAppInfoV1DeprecatedRequest = {
    appId: appId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetAppInfoV1DeprecatedRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/apps/v1/info/{appId}")(pathParams);
