 ...
 */
export async function roomsV2GetInactiveRoomsForProcess(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetInactiveRoomsForProcessRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rooms/v2/{appId}/list/{processId}/inactive")(
    pathParams,
  );
