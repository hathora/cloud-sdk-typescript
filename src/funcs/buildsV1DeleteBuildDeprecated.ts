 ...
 */
export function buildsV1DeleteBuildDeprecated(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteBuildDeprecatedRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/builds/v1/{appId}/delete/{buildId}")(pathParams);
