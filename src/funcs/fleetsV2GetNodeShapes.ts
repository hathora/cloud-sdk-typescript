 ...
 * GetNodeShapes
 */
export function fleetsV2GetNodeShapes(
  client: HathoraCloudCore,
  orgId?: string | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.NodeShapeV2>,
    | errors.ApiError
    | HathoraCloudError
...
> {
  const input: operations.GetNodeShapesRequest = {
    orgId: orgId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.GetNodeShapesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/fleets/v2/nodeShapes")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "404", "408", "422", "429", "4XX", "500", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(components.NodeShapeV2$inboundSchema)),
