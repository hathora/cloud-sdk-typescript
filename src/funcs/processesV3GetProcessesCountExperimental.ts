...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetProcessesCountExperimentalRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/processes/v3/apps/{appId}/processes/count")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetProcessesCountExperimentalResponseBody$inboundSchema),
