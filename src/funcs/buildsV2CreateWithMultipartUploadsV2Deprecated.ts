...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.CreateWithMultipartUploadsV2DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.CreateMultipartBuildParams, { explode: true });
    ...
    const path$ = pathToFunc("/builds/v2/{appId}/createWithMultipartUploads")(pathParams$);
