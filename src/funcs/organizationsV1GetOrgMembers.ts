 ...
 * GetOrgMembers
 */
export function organizationsV1GetOrgMembers(
  client: HathoraCloudCore,
  orgId: string,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.OrgMembersPage,
    | errors.ApiError
    | HathoraCloudError
...
> {
  ...
  const path = pathToFunc("/orgs/v1/{orgId}/members")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.OrgMembersPage$inboundSchema),
