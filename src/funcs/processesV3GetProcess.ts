 ...
 */
export function processesV3GetProcess(
...
> {
  const input: operations.GetProcessRequest = {
    processId: processId,
    appId: appId,
  };
  ...
  const path = pathToFunc("/processes/v3/apps/{appId}/processes/{processId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ProcessV3$inboundSchema),
