 ...
 */
export function fleetsV1GetFleetRegionDeprecated(
...
> {
  const input: operations.GetFleetRegionDeprecatedRequest = {
    fleetId: fleetId,
    region: region,
    orgId: orgId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetFleetRegionDeprecatedRequest$outboundSchema.parse(value),
