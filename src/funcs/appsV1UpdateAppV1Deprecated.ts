 ...
 */
export async function appsV1UpdateAppV1Deprecated(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UpdateAppV1DeprecatedRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/apps/v1/update/{appId}")(pathParams$);
